...
define(["require", "exports"], function (require, exports) {
    ...
    */
    ...
    var NavSidebar = (function (_super) {
        ...
        function NavSidebar(rootNode, attr, children, a, b, scope) {
            var _this = this;
            attr['tag'] = attr['tag'] || 'nav';
            attr['visible'] = attr['visible'] || false;
            ...
            this.backdrop.on('mousedown touchstart', function () { _this.hide(); });
            this.startComponent();
        }
        NavSidebar.prototype.visible_changed = function (visible) {
            if (visible) {
        ...
        NavSidebar.prototype.width_changed = function (width) {
            this.DOM.css({
                width: width,
                transform: "translate3d(-" + (this.attr('visible') ? 0 : this.width) + "px, 0, 0)"
            });
        };
        NavSidebar.prototype.show = function () {
            this.attr('visible', true);
        };
        NavSidebar.prototype.hide = function () {
            this.attr('visible', false);
        };
        __decorate([
            mz.MVCObject.proxy, 
            __metadata('design:type', Number)
        ], NavSidebar.prototype, "width", void 0);
        __decorate([
            mz.MVCObject.proxy, 
            __metadata('design:type', String)
        ], NavSidebar.prototype, "panel", void 0);
        __decorate([
            mz.core.decorators.screenDelayer, 
            __metadata('design:type', Function), 
            __metadata('design:paramtypes', [Boolean]), 
            __metadata('design:returntype', void 0)
        ], NavSidebar.prototype, "visible_changed", null);
        __decorate([
            mz.core.decorators.screenDelayer, 
            __metadata('design:type', Function), 
            __metadata('design:paramtypes', [Number]), 
            __metadata('design:returntype', void 0)
        ], NavSidebar.prototype, "width_changed", null);
        NavSidebar = __decorate([
            mz.Widget.RegisterComponent("nav-sidebar"), 
            __metadata('design:paramtypes', [HTMLElement, Object, Array, Object, Object, Object])
        ], NavSidebar);
        return NavSidebar;
    })(mz.Widget);
